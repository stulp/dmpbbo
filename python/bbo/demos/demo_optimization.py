...
from bbo.updater import UpdaterMean, UpdaterCovarDecay, UpdaterCovarAdaptation
...
if __name__=="__main__":
    ...
    for covar_update in ['none','decay','adaptation']:
        ...
        learning_curve = runOptimization(cost_function, distribution, updater, n_updates, n_samples_per_update,fig,cur_directory)
