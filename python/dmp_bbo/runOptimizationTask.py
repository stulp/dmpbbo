...
def runOptimizationTask(task, task_solver, initial_distribution, updater, n_updates, n_samples_per_update,directory=None):
    
    session = LearningSessionTask(n_samples_per_update, directory, task=task, updater=updater)
