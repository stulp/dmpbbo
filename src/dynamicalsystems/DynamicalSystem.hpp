...
It is assumed you have read about the theory behind dynamical systems in the tutorial <a href="https://github.com/stulp/dmpbbo/blob/master/tutorial/dynamicalsystems.md">tutorial/dynamicalsystems.md</a>.
