...
This is the doxygen documentation of the DmpBbo library. Its main aim is to
document the API, describe the implemenation, and provide rationale management
for developers. If you are more interested in the theory behind dynamical
...
place to go for you. If you want to get started quickly, the <a
...
This library contains several modules for training dynamical movement primitives
(DMPs), and optimizing their parameters through black-box optimization. Each
module has its own dedicated page.
...
such systems. This module is completely independent of all other modules.

\li \ref page_func_approx (in functionapproximators/) This module provides
implementations (but mostly wrappers around external libraries) of several
function approximators. DMPs use function approximators to learn and reproduce
arbitrary smooth movements. This module is completely independent of all other
modules.

\li \ref page_dmp (in dmp/) This module provides an implementation of several
types of DMPs. It depends on both the DynamicalSystems and FunctionApproximators
modules, but no other.

\li \ref page_bbo (in bbo/) This module provides implementations of several
stochastic optimization algorithms for the optimization of black-box cost
functions. This module is completely independent of all other modules.

\li \ref page_dmp_bbo (in dmp_bbo/) This module applies black-box optimization
to the parameters of a DMP. It depends on all the other modules.

\section sec_pytho_cpp A mixed C++/Python library


A part of the functionality of the C++ code has been mirrored in Python. The
Python version is probably the better language for getting to know dmpbbo
(especially if you do not know C++ ;-) The C++ code is the better choice if you
want to run dmpbbo on a real robot in a real-time environment. For now the
Python code has not been documented well, please navigate the C++ documentation
instead (class/function names have been kept consistent).

Some general considerations on the design of the library are here \ref
page_design
...
more legible or efficient are welcome. The same goes for Python actually. So be
gentle on me on this one; I myself will probably look back at this Python code
in a few years and think: "How cute... I was just a Python baby when I coded
that."

\li For consistency the names of Python modules (e.g. distribution_gaussian.py)
have been kept consistent with their respective C++ implementation (e.g.
DistributionGaussian.cpp). Several functions could also have been made mor
Pythonic by exploiting duck-typing, but again, this has not always been done to
keep consistency with the C++ code (where duck-typing is not possible).
...
in the derived classes). If they really need them, then you have to make
different functions with different argument lists (see for example
DmpContextual::train(), there are 6 of them for this reason).
...
href="https://github.com/stulp/dmpbbo/blob/master/tutorial/functionapproximators.md#unified-model-for-function-approximators"
target="_blank">tutorial/functionapproximators.md</a>

\section page_dmp_bbo Black Box Optimization of Dynamical Movement Primitives

The documentation for the dmp_bbo module is in the tutorial <a
href="https://github.com/stulp/dmpbbo/blob/master/tutorial/dmp_bbo.md"
target="_blank">tutorial/dmp_bbo.md</a>.

\section sec_bbo_task_and_task_solver CostFunction vs Task/TaskSolver

This page has moved to <a
href="https://github.com/stulp/dmpbbo/blob/master/tutorial/dmp_bbo.md#costfunction-vs-tasktasksolver"
target="_blank">tutorial/dmp_bbo.md</a>
...
This page has moved to <a
href="https://github.com/stulp/dmpbbo/blob/master/tutorial/dmp_bbo.md#cost-components"
target="_blank">tutorial/dmp_bbo.md</a>

\section sec_cost_vars Cost-relevant variables

This page has moved to <a
href="https://github.com/stulp/dmpbbo/blob/master/tutorial/dmp_bbo.md#cost-relevant-variables"
target="_blank">tutorial/dmp_bbo.md</a>
