/**
 * @file   TaskViapointArm.hpp
 * @brief  TaskViapointArm class header file.
 * @author Freek Stulp
 *
...
#ifndef TASKVIAPOINTARM_H
#define TASKVIAPOINTARM_H
 ...
 */
class TaskViapointArm : public Task
{
public:
...
BOOST_CLASS_EXPORT_KEY2(DmpBbo::TaskViapointArm, "TaskViapointArm")

/** Don't add version information to archives. */
BOOST_CLASS_IMPLEMENTATION(DmpBbo::TaskViapointArm,boost::serialization::object_serializable);
