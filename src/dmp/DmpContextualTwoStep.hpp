...
class DmpContextualTwoStep : public DmpContextual {
 public:
   ...
   *  \param policy_parameter_function Function approximators for the policy
   * parameter function \param dmp_type  The type of DMP, see Dmp::DmpType
   */
  DmpContextualTwoStep(
  ...
  void train(const std::vector<Trajectory>& trajectories,
             ...
             std::string save_directory = "", bool overwrite = true);
