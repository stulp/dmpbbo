...
python3 step3_tuneExploration.py ${D}/dmp_initial.json ${D}/tune_exploration --sigma 100.0
...
do
  ...
  ./robotExecuteDmp ${DU}/eval_dmp_dmpbbo.json ${DU}/eval_cost_vars.txt
  for i in $(seq -f "%03g" 0 4)
  do
    ./robotExecuteDmp ${DU}/${i}_dmp_dmpbbo.json ${DU}/${i}_cost_vars.txt
  done
